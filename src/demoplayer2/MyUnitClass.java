...
public abstract class MyUnitClass {
  ...
  /**
   * Generic spawn method. It tries to spawn one unit of a given type in every direction (but only
   * one in total). Also, the new unit should not be adjacent to any other. It returns true iff it
   * successfully creates the given type.
   */
